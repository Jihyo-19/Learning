...
browser = webdriver.Chrome('/Users/zhaoyan/Downloads/chromedriver')
...
/* 登陆Jenkins */
browser.find_element_by_id('j_username').send_keys('zhaoyan')
browser.find_element_by_name('j_password').send_keys('SEuGaOQV4u578')
